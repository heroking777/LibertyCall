...
生成ファイル:
- 000-004.wav: 「もしもし？　何かお話しされますか？」
- 000-005.wav: 「まだおつなぎしています。ご用件をお聞かせください。」
- 000-006.wav: 「応答が確認できませんので、この通話を終了いたします。」
"""
...
# 無音警告用のテキストとファイル名のマッピング（柔らかいトーン版）
AUDIO_CONFIGS = {
    "000-004": {
        "text": "もしもし？　何かお話しされますか？",
        "description": "5秒無音警告（柔らかいトーン）"
    },
    "000-005": {
        "text": "まだおつなぎしています。ご用件をお聞かせください。",
        "description": "15秒無音警告（柔らかいトーン）"
    },
    "000-006": {
        "text": "応答が確認できませんので、この通話を終了いたします。",
        "description": "25秒無音警告（柔らかいトーン）"
    }
}
