...
INPUT_CSV = '/opt/libertycall/scraper/data/gbizinfo_test10.csv'
OUTPUT_CSV = '/opt/libertycall/scraper/output/searxng_emails_test.csv'
DONE_FILE = '/opt/libertycall/scraper/data/searxng_done_test.txt'
